---
title: "Newsletters: An Opportunity or Timesink?"
description: "Two years and 19 issues into my newsletter, here's what actually slowed growth, what I'd change, and why it was worth every hour anyway."
publishedDate: 2026-09-02
author: "Josh Imholte"
keywords: ["newsletter growth", "email newsletter lessons", "beehiiv boosts", "building a newsletter", "newsletter marketing mistakes", "email list building"]
...
My very first issue was titled "Goals and Why the Little Things Matter," with an open rate of 75% to 8 people. I reached over 100 subscribers at my highest point so far, and today I have about 50 active readers. I'll get to the subscriber count reduction in a moment.

## Why Growth Was Slow

<img src="/blog-graphics/newsletter-growth-reasons.svg" alt="Five things that slowed newsletter growth: Focus, Positioning, Identity, Funnel, Content" style="width:100%;height:auto;" />

Here's a few reasons why I think progress was slow.

**Focus.** The newsletter was never my main focus. Writing the book was, and that's far more time consuming. That's why I opted for monthly issues only. Counterintuitive, I know. Most advice says build the newsletter first and write the book second, but that's not the order I did it in.

**Positioning.** I struggled with positioning early on. I built things like apps and digital products and banked on people caring about them. They didn't, partly because I never tested for demand before building. That created a weird product-management, productivity vibe layered on top of personal development, and the two never quite meshed.
...
**Beehiiv paid Boosts, to get more subscribers.** I could write a whole article on how I think this particular platform feature is nonsense, using what look like fake Gmail accounts to create the illusion of growth. Suspiciously, nearly all the subscribers I got from Boosts were Gmail addresses, none of them ever opened a single email, and they came from unverified locations. No gripes with the rest of the platform, but don't waste your money on Boosts.
...
1. **People are ruthless with their email**, and I know because I'm a zero-inboxer myself. You'd better be valuable, or at minimum offer something memorable and novel. We're inundated with information, and it's ridiculous how much of it we forget in a single day. In fact, research shows we lose 90% of new information within a week unless it's reinforced through repetition, anchored by strong emotion, or introduced through a novel pattern interrupt.[1] Without those triggers, the brain treats the details as noise and purges them during sleep. Repetition alone measurably slows that forgetting curve.[2]
